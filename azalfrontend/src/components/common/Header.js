  ...
  return (
    <div style={{ backgroundColor: "#00B0B5" }} className='text-white'>
      <div
        ...
        style={{ height: "53px", paddingTop: "20px", fontSize: "auto", flexShrink: "0" }}
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "center", flexShrink: "2" }}>
          <strong>
            <center>
        ...
        <Container fluid>
          ...
          <Navbar.Collapse id="navbarScroll">
            <Nav
              ...
              style={{ maxHeight: '300px', backgroundColor: "#00B0B5", justifyContent: "center" }}
              navbarScroll
            >
              <Nav.Link href="#action1" className='text-white fw-bold fs-lg-1 mx-lg-2'>WOMEN</Nav.Link>
              <Nav.Link href="#action2" className='text-white fw-bold fs-lg-1 mx-lg-2'>MEN</Nav.Link>
              <Nav.Link href="#action3" className='text-white fw-bold fs-lg-1 mx-lg-2'>KIDS</Nav.Link>
            </Nav>
            <Form
              className="d-flex justify-content-center position-relative"
              style={{ backgroundColor: "#00B0B5", flex: "1" }} 
            >
              <InputGroup style={{ width: "100%", maxWidth: "400px", margin: "0 auto" }}>
                <Form.Control
                  style={{
                    borderRadius: "10px",
                ...
                />
                <InputGroup.Text
                  style={{ backgroundColor: "#00B0B5", border: "none", position: "absolute", right: "10px", top: "50%", transform: "translateY(-50%)",zIndex:"1" }}

...
const Footer = () => {
  return (
    <div>
      <div
        className="Footer bg-warning w-full"
        style={{
          background: "#00B0B5",
          color: "white",
          padding: "3rem 0",
        ...
        <div className="container ">
          <div className="row">
            <div className="col-md-6 col-lg-5 col-12 ft-1">
              <h2>
                <span style={{ color: "#49bede" }}>
                  <b>Asal</b>
                </span>
                <b>Shope</b>
              </h2>
              <p style={{ padding: "1rem 2rem 1rem 0" }}>
                It is the best shopping app which have lots of fun in choosing
                your own and favourite products.And welcome to AZAL shope app.
              </p>

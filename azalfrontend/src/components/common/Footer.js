...
const Footer = () => {
  return (
          ...
          <div className='col-md-6 col-lg-5 col-12 ft-1'>
            ...
            <div className='col-md-6 col-lg-3 col-12 ft-2'>
              ...
              <ul style={{listStyle:'none', paddingLeft:'0', }}>
                ...
                <li className='nav-item'>
                  <a className='nav-link' href="/">Azalshope App Download</a>
                </li>
                <li className='nav-item'>
                  <a className='nav-link' href="/">Your Collection</a>
                </li>
              </ul>
            </div>
            <div className='col-md-6 col-lg-4 col-12 ft-3'>
            <h2 style={{color:'#49bede'}}><b>Contact Us</b></h2>
            <p><i class="fa-solid fa-phone-volume" ></i> +91 987654321</p>
            <p><i class="fa-solid fa-envelope"></i> azalshope@gmail.com</p>
            <p><i class="fa-solid fa-paper-plane"></i> World wide brands</p>
    ...
    <div className='last-footer' style={{background:'#00B0B5', color:'white',textAlign:'center',padding:'1rem 0'}}>
  <p>Assured Quality | 100% Handpicked | Easy Exchange</p>
            <li className='nav-item' style={{listStyle:'none'}}>
            <a className='nav-link' href="/">Already a Customer?  Sign in </a>
            </li>
